...
For use with :
https://www.skpang.co.uk/products/teensy-4-1-triple-can-board-with-ethernet

Ensure these libaries are installed:
...
{
  CAN_message_t msg;
  msg.buf[0] =  0xff & traffic1;
  msg.buf[1] = (0xff00 & traffic1) >> 8; 
  msg.buf[2] = (0xff0000 & traffic1) >> 16;  
  msg.buf[3] = (0xff000000 & traffic1) >> 24; 
  msg.buf[4] = (0xff00000000 & traffic1) >> 32; 
  msg.buf[5] = (0xff0000000000 & traffic1) >> 40;  
  msg.buf[6] = (0xff000000000000 & traffic1) >> 48; 
  msg.buf[7] = (0xff00000000000000 & traffic1) >> 56; 
  msg.id = 0x100;
  msg.len = 8;
  can1.write(msg);
  ...
  CANFD_message_t msg3;
  for ( uint8_t i = 0; i < 64; i++ ) {
    msg3.buf[i] = 0;
  }
  msg3.buf[0] =  0xff & traffic1;
  msg3.buf[1] = (0xff00 & traffic1) >> 8; 
  msg3.buf[2] = (0xff0000 & traffic1) >> 16;  
  msg3.buf[3] = (0xff000000 & traffic1) >> 24; 
  msg3.buf[4] = (0xff00000000 & traffic1) >> 32; 
  msg3.buf[5] = (0xff0000000000 & traffic1) >> 40;  
  msg3.buf[6] = (0xff000000000000 & traffic1) >> 48; 
  msg3.buf[7] = (0xff00000000000000 & traffic1) >> 56; 
...
void setup() {
  ...
  Serial.println("Teensy 4.1 Triple CAN Etherent test. www.skpang.co.uk 08/2025");
...
void loop() {
  ...
  if (FD.readMB(msg)) {
    ...
    if ( prnt ) {
     ...
     if ( Updated+CANsentPeriod <millis() ) 
     {
        Updated=millis();
        sendframe();
